...
template <typename DTYPE>
char* TextDataset<DTYPE>::GetVocab() {
    return vocab;
}
...
template <typename DTYPE>
int TextDataset<DTYPE>::GetVocabSize() {
    return vocab_size;
}

template <typename DTYPE>
std::vector<Tensor<DTYPE>*>* TextDataset<DTYPE>::GetData(int idx) {
...
template <typename DTYPE>
int TextDataset<DTYPE>::GetLength() {
    return m_numOfInput;
}
